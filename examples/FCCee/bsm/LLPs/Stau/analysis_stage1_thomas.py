...
class Analysis():
    ...
    def __init__(self, cmdline_args):
        ...
        self.output_dir = '/afs/desy.de/user/m/mrandria/DUST/STAGE1'
    ...
    def analyzers(self, df):
        ...
        df2 = (
            ...
            .Define("n_RecoedPrimaryTracks",  "ReconstructedParticle2Track::getTK_n(TrackStates)")
            ...
            .Define("RecoedPrimaryTrack_mass", "ReconstructedTrack::getTrackMass(RecoedPrimaryTracks_pt, TOF_RecoedPrimaryTracks,RecoedPrimaryTracks_theta, 2.25, 2.5)")
            ...
            # .Define("n_EscapingTracks", "ReconstructedParticle2Track::getTK_n(EscapingTrackIndices)")
            .Define("n_EscapingTracks", "EscapingTrackIndices.size()") # thomas
